...
public class CorsConfig extends WebMvcConfigurationSupport {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(loginInterceptor).addPathPatterns("/**")
                ...
                .excludePathPatterns("/dict/data/TaskOrderStatus")
                .excludePathPatterns("/dict/data/pickUpOrderStatus")
                .excludePathPatterns("/dict/data/washingOrderStatus")
                .excludePathPatterns("/dict/type/printOrderStatus")
